    ...
    return ThemeData(
      ...
      extensions: [
        MUIExtraColors(
          ...
          successBg: const Color(0xFFF6FFED),
          successDark: const Color(0xFF389E0D),
          warningBg: const Color(0xFFFFFBE6),
          warningDark: const Color(0xFFD48806),
          dangerBg: const Color(0xFFFFF1F0),
          dangerDark: const Color(0xFFA8071A),
          infoBg: const Color(0xFFEEF8FA),
          infoDark: const Color(0xFF2A73B8),
          textSecondary: const Color(0xFF344152),
          textTertiary: const Color(0xFF4E5B6A),
          textDisabled: const Color(0xFF8C96A3),
        ),
      ],
    );
  }
