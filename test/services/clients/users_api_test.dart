  ...
  group('UsersApi Tests', () {
    ...
    group('getUsers', () {
      test('should return list of users on 200', () async {
        ...
        verify(mockApiClient.get('/lab/user', query: anyNamed('query')))
            .called(1);
      });
    ...
    group('getUser', () {
      test('should return user detail on 200', () async {
        ...
        verify(mockApiClient.get('/lab/user/acc-uuid-1',
    ...
    group('updateUser', () {
      test('should complete on 200', () async {
        ...
        verify(mockApiClient.put('/lab/user/acc-uuid-1',
                body: anyNamed('body'), query: anyNamed('query')))
            .called(1);
      });
    ...
    group('createUser', () {
      test('should complete on 201', () async {
        ...
        verify(mockApiClient.post('/lab/user',
                body: anyNamed('body'), query: anyNamed('query')))
            .called(1);
      });
