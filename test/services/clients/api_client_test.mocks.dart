...
// in moustra/test/services/clients/api_client_test.dart.
...
class _FakeStreamSink_2<S> extends _i1.SmartFake implements _i3.StreamSink<S> {
...
/// A class which mocks [StreamedRequest].
///
/// See the documentation for Mockito's code generation for more information.
class MockStreamedRequest extends _i1.Mock implements _i2.StreamedRequest {
  MockStreamedRequest() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.StreamSink<List<int>> get sink =>
      (super.noSuchMethod(
            Invocation.getter(#sink),
            returnValue: _FakeStreamSink_2<List<int>>(
              this,
              Invocation.getter(#sink),
            ),
          )
          as _i3.StreamSink<List<int>>);
