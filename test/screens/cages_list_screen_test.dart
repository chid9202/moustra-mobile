...
Future<void> pumpCagesListScreen(WidgetTester tester) async {
...
void main() {
  ...
  group('CagesListScreen', () {
    testWidgets('renders correctly', (WidgetTester tester) async {
      await pumpCagesListScreen(tester);

      expect(find.byType(CagesListScreen), findsOneWidget);
    });
